...
%  otherkeywords={>,<,=,<=,>=,!,*,/,-,+,|,&,||,&&,==,=>},
  ...
  literate={\\}{\fn}{1} {->}{$\rightarrow$}{1} {<-}{$\leftarrow$}{1} {|>}{$\pipe$}{1},
}
...
\newcommand{\pipe}{\ensuremath{\triangleright}}
...
\newcommand{\attrib}[1]{\#[#1]}
\newcommand{\tang}[1]{\dot{#1}}
\newcommand{\adj}[1]{\overline{#1}}
\newcommand{\Reverse}{\kw{reverse}}
%%% Local Variables:
%%% mode: latex
%%% TeX-master: "icfp18"
%%% End:
